...
| ------------------------------ | ------------------- | ---------------------------------------------------------------------------------------------------- |
| `nlobby login`                 |                     | Open browser for interactive login (uses system Chrome if Puppeteer-bundled Chrome is not installed) |
...
| `nlobby news unread-info`   | `--json`                                                                                                                | Show unread count and flags (falls back to `getUnreadNewsCount` when `getUnreadNewsInfo` is unavailable) |
...
| `nlobby courses resources` | `--subject <name>` `--json`                                 | Show learning resources derived from required courses (追試 forms, incomplete reports) |
...
| `get_unread_news_info`        |                                                                                                                                                                                          | Unread news count and important flags (falls back to `getUnreadNewsCount` when `getUnreadNewsInfo` is unavailable) |
...
| `get_learning_resources`      | `subject?`                                                                                                                                                                               | Learning resources derived from required courses (追試 forms, incomplete reports)                                  |
...
| `interactive_login`           |                                                                                                                                                                                          | Open browser for manual login (uses system Chrome if Puppeteer-bundled Chrome is not installed)                    |
...
| `nlobby://learning-resources` | Learning Resources | Learning resources derived from required courses |
